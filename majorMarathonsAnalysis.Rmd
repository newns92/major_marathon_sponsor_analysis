...
marathons %>% 
  ...
  filter(country %in% c("Kenya","Norway","United States","United Kingdom","Germany","Ethiopia","Japan")) %>%
...
With the incredibly imporant caveat that Boston was the only WMM that existed from its initial running in 1897 until 1970 with the first running of the New York Marathon, which makes this chart pretty useless unless we cut down the time period we're looking at. But, before leaving this chart completely, we can note that German and UK wins started picking up soon after first couple of their respective marathons (chicago = 1977, berlin = 1974, london = 1981, ). We can also note that, along with the estalishof ment of NYC in 70 and CHI in 77, the "Running Boom" in USA is sahped by teh relase of # bowerman = jogging and Frank Shorter's win @ Olyumpics, culminting with Benoit.
...
Kenya's Rise starting in mid-90's, Ethiopia in early 2000's, Plateaus from other top countires, UK drough in 08 onways, u
```{r,echo=F}
 marathons %>%
  filter(!is.na(country)) %>%
