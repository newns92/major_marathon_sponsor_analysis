...
marathons %>% 
  ...
  ggplot(aes(x=year,color=country)) +
   ...
   # geom_point(aes(1967,37),size=3,color="purple") +  # bowerman = jogging
    geom_point(aes(1971,49),size=2,color="#7e7e7e") +
    geom_text(aes(x=1955, label="Frank Shorter (1972)", y=50), colour="#7e7e7e", angle=0, size=3) +
    geom_point(aes(1983,90),size=2,color="#7e7e7e") +
    geom_text(aes(x=1968, label="Joan Benoit (1984)", y=92), colour="#7e7e7e", angle=0, size=3) +
