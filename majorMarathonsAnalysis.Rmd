...
The common knowledge that Eastern Africa (i.e. Kenya and Ethiopa) are dominanting distance running is clearly displayed in the plot, followed by the United Stats and the UK (One could also choose to combine West Germany and Germany into a single grouping, but for this quick analysis I chose not to). But when did this domination by the East Africans begin?
...
With the incredibly imporant caveat that Boston was the only WMM that existed from its initial running in 1897 until 1970 with the first running of the New York Marathon, which makes this chart pretty useless unless we cut down the time period we're looking at. But, before leaving this chart completely, we can note that (chicago = 1977, berlin = 1974, london = 1981, )
